document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mobileMenuBtn) {
        mobileMenuBtn.addEventListener('click', () => {
            ...
            navLinks.classList.toggle('active'); // Needs CSS support if actually used
            // alert('Menú móvil - Implementar drawer aquí'); // Replaced alert with logic placeholder
        });
    }
    ...
    if (typeof gsap !== 'undefined') {
        gsap.registerPlugin(ScrollTrigger);
         ...
         let ctx = gsap.context(() => {
            ...
            if (!isMobile) {
                ...
                gsap.utils.toArray(".paint-hero-left").forEach(splatter => {
                    ...
                    gsap.to(splatter, {
                        ...
                        x: 100, y: 100, scale: 1.2, ease: "power2.out"
                    });
                });
                ...
                gsap.utils.toArray(".paint-hero-right").forEach(splatter => {
                    ...
                    gsap.to(splatter, {
                        scrollTrigger: { trigger: section, start: "top top", end: "bottom top", scrub: 0.5 },
                        x: -150, y: 80, scale: 1.2, ease: "power2.out"
                    });
                });
                ...
                gsap.utils.toArray(".paint-hero-yellow").forEach(splatter => {
                    ...
                    gsap.to(splatter, {
                        scrollTrigger: { trigger: section, start: "top top", end: "bottom top", scrub: 0.5 },
                        x: -100, y: -100, scale: 1.1, ease: "power2.out"
                    });
                });
            } else {
            ...
            heroTL.from(".hero h1", { y: 50, opacity: 0, duration: 1, ease: "power3.out" })
                  .from(".hero-subtext", { y: 30, opacity: 0, duration: 0.8, ease: "power3.out" }, "-=0.6")
